...
def launch_setup(context, *args, **kwargs):
    ...
    robot_spawn_y = -0.54 if robot_type_value == 'uf850' else -0.5
    gazebo_reference_pose = f"-0.2 {robot_spawn_y} 1.021 0.0 0.0 1.571"

    xarm_gazebo_world = PathJoinSubstitution([FindPackageShare('xarm_gazebo'), 'worlds', 'table.world']).perform(context)
    ...
    robot_moveit_common_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            'scene_world': xarm_gazebo_world,
            'sync_gazebo_scene': 'true',
            'gazebo_reference_pose': gazebo_reference_pose,
        }.items(),
    )
