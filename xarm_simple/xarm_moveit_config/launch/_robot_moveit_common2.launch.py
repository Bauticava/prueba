...
def launch_setup(context, *args, **kwargs):
    ...
    scene_world = LaunchConfiguration('scene_world', default='')
    sync_gazebo_scene = LaunchConfiguration('sync_gazebo_scene', default='true')
    gazebo_reference_pose = LaunchConfiguration('gazebo_reference_pose', default='')
    ...
    gazebo_scene_loader = Node(
        package='xarm_moveit_config',
        executable='gazebo_scene_to_moveit.py',
        name='gazebo_scene_to_moveit',
        output='screen',
        parameters=[{
            'world_path': scene_world,
            'frame_id': attach_to,
            'collision_object_prefix': prefix,
            'gazebo_reference_pose': gazebo_reference_pose,
        }],
        condition=IfCondition(sync_gazebo_scene),
    )
