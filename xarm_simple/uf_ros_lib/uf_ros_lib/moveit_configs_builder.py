...
class MoveItConfigsBuilder(ParameterBuilder):
    ...
    def __init__(
        ...
        **kwargs
        ...
        add_suction_tube = get_param_str('add_suction_tube', False)
        ...
        suction_tcp_offset_xyz = get_list_param_str('suction_tcp_offset_xyz', '0 0 0')
        suction_tcp_offset_rpy = get_list_param_str('suction_tcp_offset_rpy', '0 0 0')

        self.__prefix = prefix
        self.__robot_dof = dof
        self.__robot_type = robot_type
        self.__add_gripper = add_gripper
        self.__add_suction_tube = add_suction_tube
