...
def launch_setup(context, *args, **kwargs):
    ...
    # headless_env = [
    #     SetEnvironmentVariable('GZ_HEADLESS_RENDERING', '1'),
    ...
    bridge = Node(
        ...
        arguments=[
            ...
            '/world/default/remove_entity@ros_gz_interfaces/srv/RemoveEntity',
            '/tcp_cam/image@sensor_msgs/msg/Image[gz.msgs.Image',
            '/tcp_cam/camera_info@sensor_msgs/msg/CameraInfo[gz.msgs.CameraInfo',
        ],
        parameters=[{'use_sim_time': True}],
    )
